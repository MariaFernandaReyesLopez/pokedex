...
class _myHomePageState extends State<homePage> {
  var url =
      "https://raw.githubusercontent.com/ErickJPM/pokemon/master/completo.json";
  PokeHub pokeHub;
          ...
          children: const <Widget>[
            ...
            ListTile(
              title: Text(
                ...
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0, color: Colors.deepOrangeAccent),
              ),
            )
          ],
        ),
  ...
  runModelOnImage(File image) async {
    ...
    setState(() {
      ...
      if (_output.isEmpty) {
        String e="Pokemon no encontrado.";
